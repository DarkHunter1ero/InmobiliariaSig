...
function init(){
    ...
    var wmsCentroDeEstudio = new OpenLayers.Layer.WMS('CentroDeEstudio ','http://localhost:8080/geoserver/wms/',{layers: 'CentroEducativo', transparent: true},{isBaseLayer: false});
    ...
    map.addLayers([google_satellite, wmsEjes, wfsZonaInteres, wfsPropiedad, wmsNegocios, wmsTransporte, wmsServiciosPublicos, wmsCentroDeEstudio]);
